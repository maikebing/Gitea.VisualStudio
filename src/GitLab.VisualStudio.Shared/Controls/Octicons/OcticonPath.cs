using Gitea.VisualStudio.Shared.Controls.Octicons;
using System;
...
namespace Gitea.VisualStudio.Shared.Controls
{
    /// <summary>
    ...
    public class OcticonPath : Shape
    {
        ...
        public static readonly DependencyProperty IconProperty = DependencyProperty.Register(
            ...
            new FrameworkPropertyMetadata(defaultValue: Octicon.mark_Gitea, flags:
