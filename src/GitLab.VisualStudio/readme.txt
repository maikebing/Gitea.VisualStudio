...
The Gitea Extension for Visual Studio provides Gitea integration in Visual Studio 2015. Most of the extension UI lives in the Team Explorer pane, which is available from the View menu.
...
Older and pre-release/beta/untested versions are available at the releases page.
